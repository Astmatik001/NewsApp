            ...
            try
            {
                ...
                var request = new ChatRequest
                {
                    ...
                    Messages = new[]
                    {
                        ...
                        { 
                            Role = "system", 
                            Content = "Ты помощник, который делает краткий грамматический разбор английского текста для изучающих язык. Отвечай на русском, максимально кратко и по делу." 
                        },
                        new ChatMessage 
                        { 
                            Role = "user", 
